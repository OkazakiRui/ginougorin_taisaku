...
class GradeController extends Controller
{
    ...
    public function index(Request $request)
    {
        if (isset($request->food_flag)){
            ...
            $result = grade::when($request->gradeNumber, function ($q, $request){
                return $q->where("gradeNumber", $request);
            })->when($request->program, function($q, $res) {
                return $q->where("program", "like", "%$res%");
            })->get();
